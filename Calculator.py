...
class Calculator:
  def __init__(self,var):
    ...
    var.geometry('350x420')
    var.config(bg='black')
    var.resizable(False,False)

    self.equation = StringVar()
    self.entry_value = ''
    Entry(width=17, bg='light blue', font=("Arial Semi Bold", 28), textvariable=self.equation).place(x=0,y=0) 
    ...
    Button(width=11,height=4,text='C',relief='flat', bg='light gray', command=self.clear).place(x=0,y=350)
